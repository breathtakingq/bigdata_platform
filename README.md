...
В текущем виде проект развернут как single-node стенд. Для multi-node варианта компоненты можно вынести на разные VPS, изменив адреса сервисов в переменных окружения.
